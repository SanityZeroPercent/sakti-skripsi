...
$pdf->Cell(45, 14, 'KETERANGAN', 1, 0, 'C');
$pdf->Cell(60, 14, 'REKENING BANK', 1, 0, 'C');
$pdf->Cell(82, 7, 'JENIS', 1, 1, 'C'); // End the row here

$pdf->Cell(195, 0, '', 0, 0); // 10+35+45+45+60=195
...
while ($d = mysqli_fetch_array($data)) {
  ...
  $pdf->Cell(45, 7, $d['transaksi_keterangan'], 1, 0, 'C');
  $pdf->Cell(60, 7, $d['bank_nama'] . " " . $d['bank_nomor'] . " " . "a.n. " . $d['bank_pemilik'], 1, 0, 'C');
...
$pdf->Cell(195, 7, "TOTAL", 1, 0, 'R'); // 10+35+45+45+60=195
...
$pdf->Cell(82, 7, "Rp. " . number_format($total_pemasukan - $total_pengeluaran) . " ,-", 1, 1, 'C');
