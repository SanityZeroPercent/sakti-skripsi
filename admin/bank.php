...
<div class="body-header border-bottom d-flex py-3">
  <div class="container-xxl">
    <div class="row align-items-center g-2">
      <div class="col">
        <!-- Pretitle -->
        <h1 class="h4 mt-1">Kelola Rekening Bank</h1>
      </div>
      <div class="col-12 col-md-6 text-md-end">
        <button type="button" class="btn btn-primary lift" data-bs-toggle="modal" data-bs-target="#modalTambahBank">Tambah Rekening Bank</button>
      </div>
    </div> <!-- Row end  -->
  </div>
</div>
